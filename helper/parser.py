...
def create_parser():
    ...
    parser.add_argument('--adap-dec', action='store_false',help='enable adaptive-decrease')
    parser.add_argument("--dec_threshold", type=float, default=0.02,
                        help="dec_threshold")
    parser.add_argument("--dec_ratio", type=float, default=1/3,
                        help="dec_ratio")
